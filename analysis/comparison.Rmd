...
author: "Stephen Pederson and Richard Iggo"
...
dht_consensus <- dht_peaks %>% 
  ...
  mutate(
    ...
    promoter = bestOverlap(., features, var = "feature") == "promoter" & H3K27ac,
    enhancer = bestOverlap(., features, var = "feature") == "enhancer" & H3K27ac,
